...
type GraphRow = {id:string;conversationId?:string;subject?:string;bodyPreview?:string;receivedDateTime?:string;from?:{emailAddress?:{name?:string;address?:string}}};
type GraphList = { value?: GraphRow[]; '@odata.nextLink'?:string };
