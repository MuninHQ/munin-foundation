...
export type ExecutiveBriefing={
  ...
  email:{actionable:number;careerActionable:number;generalActionable:number;reviewRequired:number;lastSync?:string;topActions:EmailIntelligenceSnapshot['topActions']};
