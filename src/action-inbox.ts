...
export type ActionInboxOrigin='workspace'|'email'|'career'|'radar';
...
export function buildActionInbox(state:MuninState,email:InboxState,radar?:TrustedSourceSnapshot,now=new Date()):ActionInboxSnapshot{
