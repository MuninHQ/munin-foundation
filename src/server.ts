...
const routes:Array<[prefix:string,handler:Handler]>=[['/api/orchestrate',handleControlRoomApi],['/api/mobile/host',handleHostMobileApi],['/api/mobile/memory-ledger',handleMemoryLedgerMobileApi],['/api/mobile/documents',handleDocumentMobileApi],['/api/mobile/engineering',handleEngineeringApi],['/api/mobile/career',handleCareerMobileApi],['/api/mobile',handleMobileApi],['/api/visual-assets',handleVisualAssets],['/api/linkedin-composer',handleLinkedInComposer],['/api/linkedin-publisher',handleLinkedInPublisher],['/api/context-memory',handleContextMemory],['/api/executive-briefing',handleExecutiveBriefing],['/api/career-intelligence',handleCareerIntelligence],['/api/career-intake',handleCareerIntakeApi],['/api/council',handleCouncil],['/api/orchestration',handleOrchestration],['/api/portfolio',handlePortfolio]];
