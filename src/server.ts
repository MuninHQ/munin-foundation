...
const routes:Array<[prefix:string,handler:Handler]>=[['/api/mobile/documents',handleDocumentMobileApi],['/api/mobile/engineering',handleEngineeringApi],['/api/mobile',handleMobileApi],['/api/visual-assets',handleVisualAssets],['/api/linkedin-composer',handleLinkedInComposer],['/api/context-memory',handleContextMemory],['/api/executive-briefing',handleExecutiveBriefing],['/api/career-intelligence',handleCareerIntelligence],['/api/council',handleCouncil],['/api/orchestration',handleOrchestration],['/api/portfolio',handlePortfolio]];
